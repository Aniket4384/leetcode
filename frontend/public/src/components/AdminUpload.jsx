...
function AdminUpload(){
    ...
    const [uploadProgress, setUploadProgress] = useState(0); //kitni video upload ho chooki h
    const [uploadedVideo, setUploadedVideo] = useState(null); // store metadata about data
      ...
      const onSubmit = async (data) => {
        ...
        try {
          ...
          const uploadResponse = await axios.post(upload_url, formData, {
            // axiosClinet->> send data to localhost3000 only
            // that is why we use axiso
            headers: {
